...
<head>
    ...
    <link rel="stylesheet" href="/style/respfiliere/EtudinatAbsence.css">
            ...
            <li class="profili">
                <div class="profi1">
                    <button class="but-profi"><div class="im1"></div></button> 
                      <div class="profi2">
                        <a href="/index/respfiliere/profil.php">profil</a>
                        <a href="desconecter.php">desconecter</a>
                      </div>
                  </div>
            </li>
            <li>
  ...
  <aside class="Etudinfo">
      ...
      <section class="partiem">
        <table id="dtBasicExample" class="table " cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            if (isset($_POST['classe_profesr_module']) || isset($_POST['classe_etudiant'])) { //|| isset($_POST['modifier_etudiant'])
              $selected_module_id = isset($_POST['idm1']) ? $_POST['idm1'] : "";
              $selected_classe_id = isset($_POST['idc1']) ? $_POST['idc1'] : "";
              if ($selected_classe_id == NULL || $selected_module_id == NULL) {
                $selected_classe_id = isset($_POST['idc2']) ? $_POST['idc2'] : "";
                $selected_module_id = isset($_POST['idm2']) ? $_POST['idm2'] : "";
              }
    ...
    <aside class="Etudinfo2">
      <div class="cherchestudent">
        ...
        <?php      
        if (isset($_POST['classe_etudiant']) || isset($_POST['modifier_etudiant'])) {
          $selected_etud_id =  isset($_POST['ide2']) ? $_POST['ide2'] : "";
          $selected_module_id = isset($_POST['idm2']) ? $_POST['idm2'] : "";
          $selected_classe_id = isset($_POST['idc2']) ? $_POST['idc2'] : "";

          if ($selected_etud_id == NULL || $selected_module_id == NULL || $selected_classe_id = NULL) {
            $selected_etud_id = $_POST['ide3'];
            $selected_module_id = $_POST['idm3'];
            $selected_classe_id = $_POST['idc3'];
          }
          ...
          echo '</ul>
                 ...
                 <div class="modifierinfetud">
                    <form method="post" class="formmodifier">
                       ...
                       <input type="hidden" name="ide3" value="' . $selected_etud_id . '"> 
                       <input type="hidden" name="idm3" value="' . $selected_module_id . '">               
                       <input type="hidden" name="idc3" value="' . $selected_classe_id . '"> 
                    </form>
                 </div>
                   ';
          }
