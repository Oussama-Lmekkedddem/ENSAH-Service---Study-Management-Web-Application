...
<head>
    ...
    <link rel="stylesheet" href="/style/respfiliere/accueil.css">
                ...
                <div class="profi1">
                    <button class="but-profi"><div class="im1"></div></button> 
                      <div class="profi2" style="z-index: 10;">
                        <a href="/index/respfiliere/profil.php" style="z-index: 10;">profil</a>
...
?>
    ...
    <div class="taskespalce">
        <div class="emploi">
            ...
            <div class="final"><a href="/index/respfiliere/emploi.php"><p>more</p></a><h2>></h2></div>
        </div>
        <div class="profil">
            <div class="iceon-name">
              <p>Profil</p>
            ...
            <div class="linediv1"></div>
            <div class="final"><a href="/index/respfiliere/profil.php">more</a><h2>></h2></div>
        </div>
        <div class="module-note">
            ...
            <div class="linediv1"></div>
            <div class="final"><a href="/index/respfiliere/Modulenote.php">more</a><h2>></h2></div>
        </div>
        <div class="etud-absn">
            <div class="iceon-name">
            ...
            <div class="linediv1"></div>
            <div class="final"><a href="/index/respfiliere/EtudinatAbsence.php">more</a><h2>></h2></div>
        </div>
    </div>
