...
<head>
    ...
    <link rel="stylesheet" href="/style/respfiliere/Modulenote.css">
            ...
            <div class="EnsgResp">
                <div class="Ensg">
                    ...
                    $sql = "SELECT mcpf.id_prof, mcpf.id_module, mcpf.id_classe, m.nom_module, m.type_module, m.nombre_heur, c.nom_classe 
                            ...
                            WHERE mcpf.idprof = $idprofesseurinitial AND mcpf.id_filiere=$idfiliereinitial ";
                ...
                <div class="Resp">
                    ...
                    ';
                    $sql = "SELECT mcpf.id_prof, mcpf.id_module, mcpf.id_classe, m.nom_module, m.type_module, m.nom_breheur, c.nom_classe 
                            FROM module_classe_professeur_filiere AS mcpf
                            JOIN module AS m ON mcpf.id_module=m.id_module
                            JOIN classe AS c ON mcpf.id_classe=c.id_classe
