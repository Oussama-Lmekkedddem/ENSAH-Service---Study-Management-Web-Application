...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (isset($_FILES["pdf-file"]) && $_FILES["pdf-file"]["error"] == UPLOAD_ERR_OK) {
    $tmpFilePath = $_FILES["pdf-file"]["tmp_name"];
    $originalFileName = $_FILES["pdf-file"]["name"];
    $uploadDirectory = "chemin/vers/votre/dossier/de/destination/";
...
<head>
    ...
    <link rel="stylesheet" href="/style/respfiliere/profil.css">
                ...
                <form method="post" action="">
                    ...
                    <div class="underinfo">
                        <div class="imageinsert">
                          ...
                          <input class="imginput" type="file" id="pdf-file" name="pdf-file">
                       </div>
